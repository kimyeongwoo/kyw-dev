...
- Hosted post-change CI is `NOT RUN` in this pre-commit evidence. It is expected to start only after the separately authorized branch push/PR and is not used to claim the Task's local PASS.
